...
public class AdapterCompleteFTeamChat extends RecyclerView.Adapter<AdapterCompleteFTeamChat.MyHolder> {
    ...
    public AdapterCompleteFTeamChat(Context context, ArrayList<ModelTeamChat> modelChats) {
