...
public class AdapterCompleteTeamChat extends RecyclerView.Adapter<AdapterCompleteTeamChat.MyHolder> {
    ...
    public AdapterCompleteTeamChat(Context context, ArrayList<ModelTeamChat> modelChats) {
...
//        });
    ...
    public int getItemViewType(int position) {
        ...
        if (modelChats.get(position).getSender().equals("103")) {
