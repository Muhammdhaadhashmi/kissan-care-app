...
public class AdapterPersonalChat extends RecyclerView.Adapter<AdapterPersonalChat.MyHolder> {
    ...
    int duration=0;
    public AdapterPersonalChat(Context context, ArrayList<ModelTeamChat> modelChats) {
    ...
    public int getItemViewType(int position) {
        ...
        if (farmerManager.getBooleanData("farmer")){
            //Toast.makeText(context, ""+farmerUserModel.getId(), Toast.LENGTH_SHORT).show();
            userID = farmerUserModel.getId();
        }else if (supportTeamManager.getBooleanData("support")){
            //Toast.makeText(context, ""+supportTeamModel.getAdmin_id(), Toast.LENGTH_SHORT).show();
