...
public class AdapterDistrict extends RecyclerView.Adapter<AdapterDistrict.MyHolder>{

    final Context context;
    final ArrayList<DistrictModel> userList;

    public AdapterDistrict(Context context, ArrayList<DistrictModel> userList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.name.setText(userList.get(position).getDistrict_name());
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//               if(context instanceof FamerProfile){
//                        ((FamerProfile)context).Set_Item(userList.get(position),holder.getAdapterPosition());
//                }
