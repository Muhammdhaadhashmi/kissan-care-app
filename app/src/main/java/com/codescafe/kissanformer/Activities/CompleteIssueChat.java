...
import com.codescafe.kissanformer.adapter.AdapterCompleteFTeamChat;
...
public class CompleteIssueChat extends AppCompatActivity {

    ImageView back;
    AdapterCompleteFTeamChat adapterCompleteTeamChat;
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()){
                            ...
                            adapterCompleteTeamChat = new AdapterCompleteFTeamChat(CompleteIssueChat.this,list);
