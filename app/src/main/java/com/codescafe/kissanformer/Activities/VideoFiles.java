...
public class VideoFiles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        password.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                AdapterPdf adapterIncoming = new AdapterPdf(VideoFiles.this, array_sort);
                rvVideo.setAdapter(adapterIncoming);
    ...
    private void LoadPost() {
        RequestQueue queue = Volley.newRequestQueue(VideoFiles.this);
                        ...
                        try {
                            ...
                            if (list.size() > 0) {
                                for (int i=0;list.size()>i;i++){
                                    if (list.get(i).getFar_type().equals("3")){
                                ...
                                if (sortList.size()>0){
                                    ...
                                    AdapterPost adapterIncoming = new AdapterPost(VideoFiles.this, sortList);
                                    rvVideo.setAdapter(adapterIncoming);
                                }
                                if (sortList.size()==0){
                                    progressBar.setVisibility(View.GONE);
