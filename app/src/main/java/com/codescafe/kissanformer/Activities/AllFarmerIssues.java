...
public class AllFarmerIssues extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_farmer_issues);
        ...
        FirebaseDatabase.getInstance().getReference("Support Chat").child(id).child("Issues").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    adapterIssues = new AdapterIssues(AllFarmerIssues.this,list);
