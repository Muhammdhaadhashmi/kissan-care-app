...
public class SupportTeamManager {
    ...
    public SupportTeamManager(Context context) {
    ...
    public void setUserDetails(String key, SupportTeamModel val) {
        mEditor.putString(user, new Gson().toJson(val));
        mEditor.commit();
    }

    public SupportTeamModel getUserDetails(String key) {
        return new Gson().fromJson(mPrefs.getString(user, ""), SupportTeamModel.class);
    }
